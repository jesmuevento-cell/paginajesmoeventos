...
export const DEMO_ACCOUNTS: DemoAccount[] = [
  ...
  {
    email: 'validador@thevoicelundasul.ao',
    password: 'admin',
    masterPin: 'valida2026',
    role: 'Validador',
    name: 'Mesa de Validação Oficial',
    desc: 'Verificação minuciosa e aprovação de inscrições e pagamentos',
    avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80',
  },
  {
    email: 'operador@thevoicelundasul.ao',
    password: 'admin',
    masterPin: 'apoio2026',
    role: 'Operador',
    name: 'Apoio e Atendimento ao Candidato',
    desc: 'Consulta de inscrições, verificação de dados e suporte ao candidato',
